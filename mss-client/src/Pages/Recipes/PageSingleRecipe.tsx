...
export const PageSingleRecipe = () => {
	...
	console.log("🚀 ~ PageSingleRecipe ~ singleRecipeCaloriesStatsFromAPI:", singleRecipeCaloriesStatsFromAPI);
	console.log("🚀 ~ PageSingleRecipe ~ singleRecipeFromAPI:", singleRecipeFromAPI);
